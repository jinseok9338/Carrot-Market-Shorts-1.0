...
export const Login: FC<ILoginProps> = ({ setLogin }) => {
  ...
  return (
    <>
      ...
      />
      <div className="bg-[#FFECAA] w-[15vw] h-[3vh] ml-3 absolute top-[14vh] left-[12vw] z-[1] flex justify-center   ">
        <span className="font-[1rem] ">email</span>
      </div>
      <div className="h-full w-full flex flex-col items-center justify-around ">
        <div className="flex flex-col items-center h-[13.5vh] mb-[2vh] ">
          <span className="text-[1.3rem]  mr-[44vw] mt-[3vh]  ">
            Welcome Back!!!
          </span>
        ...
        <form
          method="post"
          action="/api/login"
          className="flex flex-col-reverse items-center h-[23vh] justify-start "
        >
          <div className="flex flex-row mb-[2.5vh] ml-[7vw] mt-[1.5vh] ">
            <input
              type="checkbox"
              className="box-border h-1 w-1 p-2 border border-black rounded-[1vw] bg-[#D7D7D7] mr-[1vw] appearance-none checked:bg-[#363336] "
            />
            <span className="text-[0.7rem] mr-[20vw] ">Remember me</span>
            <span className="text-[0.78rem]  mr-[8vw]">
          ...
          <input
            type="password"
            placeholder="************"
            className="w-[80vw] h-[7.5vh] mt-[2.5vh] rounded-[3vw] text-[1.3rem] pl-[4.2vw] pt-[0vh] border-[0.25vw] bg-[#FFECAA]  "
            onChange={(e) => setPassword(e.target.value)}
          />
          <input
            type="text"
            placeholder="example@mail.com"
            className="w-[80vw] h-[7.5vh] rounded-[3vw] text-[1.3rem] pl-[4.2vw] pt-[0vh] border-[0.5vw]  bg-[#FFECAA]  "
        ...
        <div className="mb-[2vh] mt-[0vh] ">
          <span className="mr-[2vw] text-[1rem]">Don't have an account?</span>
          <a
